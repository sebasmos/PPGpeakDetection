function [Sensibity,Especificity] = Gaussian_1_MA()
% clc
% clear all
% close all
%% Add Datasets
...
%   Ruido total 2: o(t) = n(t)+w(t)
    GaussianTotalMA(1:3750)      = mediaMA(1:3750) + TotalMA(1:3750);
    GaussianTotalMA(3751:11250)  = mediaMA(3751:11250) + TotalMA(3751:11250);
    GaussianTotalMA(11251:18750) = mediaMA(11251:18750) + TotalMA(11251:18750);
    GaussianTotalMA(18751:26250) = mediaMA(18751:26250) + TotalMA(18751:26250);
    GaussianTotalMA(26251:33750) = mediaMA(26251:33750) + TotalMA(26251:33750);
    GaussianTotalMA(33751:35989) = mediaMA(33751:35989) + TotalMA(33751:35989);
    % Cleaning signal with MA
    CleanedMA1 = Activity1 - GaussianTotalMA(1:3750);
    CleanedMA2 = Activity2 - GaussianTotalMA(3751:11250);
    CleanedMA3 = Activity3 - GaussianTotalMA(11251:18750);
    CleanedMA4 = Activity4 - GaussianTotalMA(18751:26250);
    CleanedMA5 = Activity5 - GaussianTotalMA(26251:33750);
    CleanedMA6 = Activity6 - GaussianTotalMA(33751:35989);
