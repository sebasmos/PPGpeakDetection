...
if(LOCSPPG(1)<LOCSECG(1))
    corrimiento=(LOCSECG(2)-LOCSPPG(2))*Fs;
    %si el corrimiento es positivo es porque ocurrio primero PPG, entonces
    ...
    %si el corrimiento es negativo es porque ocurrio primero ECG, entonces
