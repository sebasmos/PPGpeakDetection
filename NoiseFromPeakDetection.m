...
%% Señal PPG artificial centrada en picos
 ...
 PPG1 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,7.5);
 hold on 
 PPG2 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,18);
 hold on 
 PPG3 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,22);
 hold on 
 PPG4 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,26);
 hold on 
 PPG5 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,38);
 hold on 
 PPG6 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,60);
 hold on 
 PPG7 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,70);
 hold on 
 PPG8 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,78);
 hold on 
 PPG9 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,88);
 hold on 
 PPG10 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,98);
 hold on 
 PPG11 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,108);
 hold on 
 PPG12 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,118);
 hold on 
 PPG13 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,127);
 hold on 
 PPG14 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,136);
 hold on 
 PPG15 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,147);
 hold on 
 PPG16 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,157);
 hold on 
 PPG17 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,169);
 hold on 
 PPG18 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,179);
 hold on 
 PPG19 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,200,190);
 hold on 
 PPG20 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,200);
 hold on 
 PPG21 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,210);
 hold on 
 PPG22 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,220);
 hold on 
 PPG23 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,210);
 hold on 
 PPG24 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,220);
 hold on 
 PPG25 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,230);
 hold on 
 PPG26 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,240);
 hold on 
 PPG27 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,250);
 hold on 
 PPG28 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,260);
 hold on 
 PPG29 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,272);
 hold on 
 PPG30 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,282);
 hold on 
 PPG31 = ppgSignalModel(0.7,2.5,0.4,1,1.23,0.12,0,300,300);
